package de.fraunhofer.ipa.ros.xtext.ide.contentassist;
...
public class RosIdeContentProposalProvider extends IdeContentProposalProvider {
	@Inject
	private RosGrammarAccess RosGrammarAccess;
	...
	protected void _createProposals(RuleCall ruleCall, ContentAssistContext context,
		...
		if (RosGrammarAccess.getGreetingRule().equals(ruleCall.getRule()) && context.getCurrentModel() != null) {
			IScope scope = scopeProvider.getScope(context.getCurrentModel(), RosPackage.Literals.GREETING__FROM);
